...
/**
 * The SDTLogicOracle offers functions that are needed for processing counterexamples and constructing branching.
 *
 * @author falk
 */
public interface SDTLogicOracle {
     ...
     * @return
     */
    boolean hasCounterexample(Word<? extends SymbolInstance<?>> prefix,
                              SDT sdt1, SDT sdt2, Expression<Boolean> guard, Word<? extends SymbolInstance<?>> rep);
    ...
    Expression<Boolean> getCEGuard(Word<? extends SymbolInstance<?>> prefix, SDT sdt1, SDT sdt2);
    ...
    boolean accepts(Word<? extends SymbolInstance<?>> word, Word<? extends SymbolInstance<?>> prefix, SDT sdt);
}
