...
/**
 * Adapter for using {@link TTTLambdaDFA} as a procedural learner.
 *
 * @param <I>
 *         input symbol type
 */
public class TTTLambdaAdapterDFA<I> extends TTTLambdaDFA<I> implements AccessSequenceTransformer<I> {

    public TTTLambdaAdapterDFA(Alphabet<I> alphabet, MembershipOracle<I, Boolean> oracle) {
